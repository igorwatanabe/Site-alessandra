        ...
        <div className={styles.footerGrid}>
          ...
          <div>
            ...
            <div className={styles.socials}>
              ...
              <a
                href="https://open.spotify.com/show/0340TxeUZIjQjYoFpk23xf"
                className={styles.soc}
                aria-label="Spotify"
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path d="M12 1.8A10.2 10.2 0 1 0 12 22.2 10.2 10.2 0 0 0 12 1.8Zm4.68 14.7a.64.64 0 0 1-.88.21c-2.42-1.48-5.47-1.81-9.06-.99a.64.64 0 1 1-.28-1.25c3.93-.9 7.3-.52 9.99 1.13.3.18.4.59.23.9Zm1.26-2.8a.8.8 0 0 1-1.1.26c-2.77-1.7-6.99-2.19-10.26-1.2a.8.8 0 1 1-.46-1.53c3.74-1.13 8.39-.58 11.56 1.36.38.23.5.73.26 1.11Zm.11-2.92C14.73 8.87 9.25 8.7 5.98 9.69a.96.96 0 1 1-.56-1.84c3.75-1.14 8.73-.92 12.6 1.38a.96.96 0 0 1 .03 1.65Z" />
                </svg>
              </a>
            </div>
